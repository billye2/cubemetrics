...
export const ADAPTERS: SpineAdapter[] = [bills, brag, budget, caffeine, calendar, carcare, countdown, dailyplanner, energy, flashcards, goals, gratitude, grocery, habits, invoices, journal, kanban, keepintouch, medication, meditation, mood, plantcare, productivity, projecttracker, routines, screentime, sleep, steps, stress, todo, vocabulary, water, weight, workout, writingtracker];
